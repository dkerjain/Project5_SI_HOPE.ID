...
<section class="kahfibwa mt-5">
    ...
    <div class="row">                
        <div class="col-md-12">
            ...
            <div class="col-12 col-sm-6">
              <h3 for="exampleFormControlInput1" class="d-inline-block d-sm-none">Jawara Farm Surabaya</h3>
              <div class="col-12">
            ...
            <div for="exampleFormControlInput1" class="col-12 col-sm-6">
              <h3 for="exampleFormControlInput1" class="my-3">Jawara Farm Surabaya</h3>
  ...
  <script>
    function recount(){
      ...
      var total = parseInt(103/100*sembarang);
